...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">Que voulez vous supprimer?</a>
    ...
    ?>
      ...
      <div class="card" style="width: 18rem;">
        ...
        <div class="card-body">
          ...
          <a href="supp.php?id=<?php echo $produit->id ?>" class="btn btn-primary" onclick="return confirm('Are you sure?')"> Supprimer</a>
        </div>
      </div>
